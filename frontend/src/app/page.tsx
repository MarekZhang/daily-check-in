      ...
      <div className="max-w-7xl mx-auto flex flex-col justify-center items-center mt-32">
        <div className="flex flex-col items-center justify-center mb-4 space-y-2 text-gray-500">
          ...
          <div className="w-full flex space-x-2 justify-center py-4">
            ...
            <button className="whitespace-normal w-auto p-2 border border-green-300 rounded-md bg-green-400 hover:bg-emerald-400 font-semibold text-white">
              {"Let's Go !"}
            </button>
          </div>
        </div>
        ...
        <div className="shadow-md rounded-2xl w-2/3 pb-4 flex flex-col items-center justify-center mt-10 border border-gray-200">
          ...
          <div className="mt-10 flex justify-between space-x-4 w-2/3">
            <RankingButton
              ...
              onClick={() => setRankingMethod("Today")}
            />
            <RankingButton
              text="Week"
        ...
        <div className="w-2/3 mt-10 space-y-4">
          <div className="rounded-lg w-full border borger-gray-300 bg-teal-50 flex justify-between items-center px-8 py-2">
            <div className="flex items-center space-x-4">
              <p className="ml-4 text-xl underline">5</p>
          ...
          <div className="h-16 rounded-lg w-full border borger-gray-300 bg-teal-50"></div>
          <div className="h-16 rounded-lg w-full border borger-gray-300 bg-teal-50"></div>
